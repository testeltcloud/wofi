        ...
        {children ?? (
          <div className="mx-auto max-w-6xl">
            <div className="fancy-corners reveal">
              <div className="min-h-[320px] overflow-hidden rounded-[1.75rem] bg-white shadow-[0_30px_80px_-44px_rgba(11,16,32,0.4)] ring-1 ring-black/[0.04] sm:min-h-[400px] lg:min-h-[480px]" />
            </div>
          </div>
        )}
      </div>
